 ...
 * users to reference them by number instead of using potentially ambiguous keywords.
 * 
 * The mapping is client-specific and resets with each new command that generates
...
public class DisambiguationSystem extends SingletonGameSystem {
	 ...
	 * Contains the formatted markup parts, numeric ID mapping, and extracted keywords.
	 */
	 ...
	 * Since fuzzy matching supports substring matching, we can just return the full description.
	 * This allows users to match on ANY word in the description.
	 * 
	 * @param description The full description (e.g., "a smooth pebble", "peaceful meadow with wildflowers")
	 ...
	 * @return DisambiguatedList containing formatted markup, ID mapping, and keywords
	 */
	 ...
	 * This allows the client to reference entities by number in subsequent commands.
	 * 
