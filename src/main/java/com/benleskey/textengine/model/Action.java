 ...
 * Actions are stored in the database and extend Reference for consistent ID handling.
 * 
 * Action properties (actor, target, time required, etc.) are stored in a flexible
 * key-value property table, allowing different action types to have different properties.
 * 
