 ...
 * This defines what happens when the entity is cut, not the cutting logic
 * itself.
...
public interface Cuttable {
	 ...
	 * @return Boolean indicating if the cut action was handled
	 */
	boolean onCut(Entity actor, Entity tool);
}
