...
import com.benleskey.textengine.plugins.ember.systems.NewPlayerSystem;
import com.benleskey.textengine.plugins.procgen2.ProceduralWorldPlugin;
...
public class EmberPlugin extends Plugin implements OnPluginRegister, OnPluginInitialize {
    ...
    public Set<Plugin> getDependencies() {
        return Set.of(game.getPlugin(ProceduralWorldPlugin.class));
    }
