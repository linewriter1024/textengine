package com.benleskey.textengine.plugins.worldgen.procgen1;
...
import com.benleskey.textengine.plugins.games.highfantasy.entities.SimpleAvatar;
...
public class ProceduralWorldPlugin extends Plugin
	...
	public void onStartClient(Client client) throws InternalException {
		...
		com.benleskey.textengine.plugins.games.highfantasy.entities.Rattle rattle = com.benleskey.textengine.plugins.games.highfantasy.entities.Rattle
				.create(game, random);
	...
	private Avatar findOrCreatePlayerActor() throws InternalException {
		...
		var timepiece = com.benleskey.textengine.plugins.games.highfantasy.entities.Timepiece.create(game, random);
		relationshipSystem.add(actor, timepiece, relationshipSystem.rvContains);

		// Add axe for testing tree cutting
		var axe = com.benleskey.textengine.plugins.games.highfantasy.entities.Axe.create(game, random);
		relationshipSystem.add(actor, axe, relationshipSystem.rvContains);

		var clock = com.benleskey.textengine.plugins.games.highfantasy.entities.clock.GrandfatherClock.create(game,
				random);
		...
		var chest = com.benleskey.textengine.plugins.games.highfantasy.entities.WoodenChest.create(game, random);
		relationshipSystem.add(startingPlace, chest, relationshipSystem.rvContains);

		// Put some items in the chest for testing
		var coin = com.benleskey.textengine.plugins.games.highfantasy.entities.AncientCoin.create(game, random);
		relationshipSystem.add(chest, coin, relationshipSystem.rvContains);

		var scroll = com.benleskey.textengine.plugins.games.highfantasy.entities.WeatheredScroll.create(game, random);
	...
	private void spawnGoblinNPC(Entity startingPlace, Entity roomA, Entity roomB) {
		...
		var goblin = com.benleskey.textengine.plugins.games.highfantasy.entities.Goblin.create(
