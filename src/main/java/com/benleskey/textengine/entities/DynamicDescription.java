 ...
 * 
 * For example, a clock can show the current time, a thermometer can show temperature,
...
public interface DynamicDescription {
	 ...
	 * This is called when the entity is examined and is shown after the basic description.
	 * 
	 * @return The dynamic description text, or null if no dynamic description is available
	 */
